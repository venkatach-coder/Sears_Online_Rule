...
class Construct_DP_Rule(harlem.DP_Rule_Constructor):
    def __init__(self):
        super().__init__(rule_level=1000, scope='div_no = 14',
                         is_active=True,
                         rule_name='div_14 HOME Regular DP Rule')
    ...
    def get_uplift_rule(self):
        func_handle = partial(uplift_rule._uplift_by_percentage_max_no_free_shipping, uplift=1.07, max_val=float('inf'))
        return [
            Working_func(func_handle, '1.07 Uplift')
        ]
